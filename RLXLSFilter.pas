...
begin
  ...
  else if not ((ValueText+' ')[1] in ['1'..'9', '-', '(']) then
    Exit;
  ...
  begin
    ...
    ValueText := StringReplace(ValueText, '.', DecimalSeparator, [rfReplaceAll]);
    Result := True;
  end;
end;
...
begin
  ...
  begin
    if (Tabs[I].TextOrigin='01') or (Tabs[I].TextOrigin='DOM') then
      Tabs[I].TextOrigin:=Tabs[I].TextOrigin;
...
begin
  ...
  begin
    ...
    if CellAreaIntercepts(AreaNew, AreaOld) then
...
{Fred/Tiago        // só me interessam os textos nao vazios, pois nao vou criar celulas vazias
    ...
    begin
      ...
      // se eu mandar AnsiString vazia para o excel, ele repete o valor de uma celula celula
